...
// ============================================
// NOVAS VARIÁVEIS DO MAPA
// SOMENTE PARA CONTROLE DAS BOLINHAS
// ============================================

let nivelMapaAtual = null;

let redesenhandoMarcadores = false;
...
function inicializarMapa() {
    ...
    // ========================================
    // ALTERAÇÃO DO MAPA:
    // ATUALIZA AS BOLINHAS AO DAR ZOOM
    // ========================================
...
async function desenharMarcadores() {
    ...
    if (redesenhandoMarcadores) {
        return;
    }

    redesenhandoMarcadores = true;

    try {

        // ----------------------------------------
        // DESCOBRIR O NÍVEL ATUAL DO MAPA
        // ----------------------------------------
        ...
        // ----------------------------------------
        // SE O NÍVEL NÃO MUDOU, NÃO REDESENHA
        // ----------------------------------------

        if (
            nivel === nivelMapaAtual &&
            marcadores.length > 0
        ) {
            return;
        }
        ...
        await desenharMarcadoresCidades();

    } finally {

        redesenhandoMarcadores = false;
...
// ============================================
// ATUALIZAR MARCADORES AO DAR ZOOM
// ============================================

async function atualizarMarcadoresPorZoom() {
...
function desenharMarcadoresEstados() {
...
async function desenharMarcadoresCidades() {
...
function calcularFonteMarcador(
    tamanho
) {
